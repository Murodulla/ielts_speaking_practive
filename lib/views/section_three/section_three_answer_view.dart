...
class SectionThreeAnswerView extends StatefulWidget {
  final String title;
  final Question item;
  final List<Vocabulary> vocabulary;

  const SectionThreeAnswerView(
      {super.key,
      required this.title,
      required this.item,
  ...
  @override
  State<SectionThreeAnswerView> createState() => _SectionThreeAnswerViewState();
}

class _SectionThreeAnswerViewState extends State<SectionThreeAnswerView> {
