...
SectionOne sectionOneFromMap(String str) =>
    SectionOne.fromMap(json.decode(str));

String sectionOneToMap(SectionOne data) => json.encode(data.toMap());

class SectionOne {
  final bool active;
  final bool free;
  final String name;
  final String sectionOneNew;
  final int order;
  ...
  SectionOne({
    ...
    required this.free,
    required this.name,
    required this.sectionOneNew,
    required this.order,
    required this.questions,
    required this.vocabulary,
  });

  factory SectionOne.fromMap(Map<String, dynamic> json) => SectionOne(
        active: json["active"],
        free: json["free"],
        name: json["name"],
        sectionOneNew: json["new"],
        order: json["order"],
